...
import { DonationCard } from "~/pages/donation";

const DetailDonation = () => {
  const session = useSession();
  const router = useRouter();

  const handleShowDonationModal = async () => {
  ...
  return (
    <Layout title="Peduli Lingkungan - 1.000 Pohon Untuk Indonesia">
      <div className="container mx-auto px-4 py-6 md:py-10 xl:max-w-5xl">
          ...
          <div className="">
            ...
            <div className="mt-6 flex flex-col gap-2">
              <div className="flex items-center justify-between gap-4">
                <span className="text-gray-500">Batas Pengumpulan Donasi:</span>
            ...
            <Button className="mt-6 w-full" onClick={handleShowDonationModal}>
              Donasi Sekarang
            </Button>
          </div>
        </div>
        ...
        <div className="mt-10">
          <div className="flex items-center justify-between">
            <h2 className="text-lg">Donasi Lainnya</h2>
            <Link href="/">Lihat Lainnya</Link>
          </div>
          <div className="mt-2 grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            {Array(3)
